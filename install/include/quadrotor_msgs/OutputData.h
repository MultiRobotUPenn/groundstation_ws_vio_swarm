...
struct OutputData_
{
  ...
  _radio_channel_type radio_channel;
   ...
   typedef boost::array<int16_t, 4>  _motor_rpm_type;
...
struct MD5Sum< ::quadrotor_msgs::OutputData_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x7ff6c904c90ab995ULL;
  static const uint64_t static_value2 = 0x159b165f2f3eeacfULL;
};
...
struct Printer< ::quadrotor_msgs::OutputData_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::quadrotor_msgs::OutputData_<ContainerAllocator>& v)
  {
    ...
    s << indent << "motor_rpm[]" << std::endl;
    for (size_t i = 0; i < v.motor_rpm.size(); ++i)
    {
      s << indent << "  motor_rpm[" << i << "]: ";
      Printer<int16_t>::stream(s, indent + "  ", v.motor_rpm[i]);
    }
    s << indent << "seq: ";
