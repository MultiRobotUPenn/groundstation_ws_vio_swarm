...
class TRPYCommand(genpy.Message):
  _md5sum = "f80239b313b23c6da7a6269aae03beb6"
...
"""
  __slots__ = ['header','thrust','roll','pitch','yaw','angular_velocity','kR','kOm','aux']
  _slot_types = ['std_msgs/Header','float64','float64','float64','float64','geometry_msgs/Vector3','float64[3]','float64[3]','quadrotor_msgs/AuxCommand']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_7d().pack(_x.thrust, _x.roll, _x.pitch, _x.yaw, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.thrust, _x.roll, _x.pitch, _x.yaw, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z,) = _get_struct_7d().unpack(str[start:end])
      start = end
      end += 24
