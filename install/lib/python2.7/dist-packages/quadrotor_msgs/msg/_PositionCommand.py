...
class PositionCommand(genpy.Message):
  _md5sum = "340cea662b21ef26b7f141decc78581f"
...
float64 y
float64 z"""
  __slots__ = ['header','position','velocity','acceleration','jerk','yaw','yaw_dot','kx','kv']
  _slot_types = ['std_msgs/Header','geometry_msgs/Point','geometry_msgs/Vector3','geometry_msgs/Vector3','geometry_msgs/Vector3','float64','float64','float64[3]','float64[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,position,velocity,acceleration,jerk,yaw,yaw_dot,kx,kv
