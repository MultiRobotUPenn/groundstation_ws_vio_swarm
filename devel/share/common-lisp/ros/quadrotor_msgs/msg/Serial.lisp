...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Serial>)))
  ...
  "9ee8250f3c8acf06cd1e69efda32eb90")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Serial)))
  "Returns md5sum for a message object of type 'Serial"
  "9ee8250f3c8acf06cd1e69efda32eb90")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Serial>)))
  ...
  (cl:format cl:nil "# Note: These constants need to be kept in sync with the types~%# defined in include/quadrotor_msgs/comm_types.h~%uint8 SO3_CMD = 115 # 's' in base 10~%uint8 TRPY_CMD = 112 # 'p' in base 10~%uint8 PWM_CMD = 119 # 'w' in base 10~%uint8 STATUS_DATA = 99 # 'c' in base 10~%uint8 OUTPUT_DATA = 100 # 'd' in base 10~%~%Header header~%uint8 channel~%uint8 type # One of the types listed above~%uint8[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Serial)))
  "Returns full string definition for message of type 'Serial"
  (cl:format cl:nil "# Note: These constants need to be kept in sync with the types~%# defined in include/quadrotor_msgs/comm_types.h~%uint8 SO3_CMD = 115 # 's' in base 10~%uint8 TRPY_CMD = 112 # 'p' in base 10~%uint8 PWM_CMD = 119 # 'w' in base 10~%uint8 STATUS_DATA = 99 # 'c' in base 10~%uint8 OUTPUT_DATA = 100 # 'd' in base 10~%~%Header header~%uint8 channel~%uint8 type # One of the types listed above~%uint8[] data~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
