...
(cl:defmethod motor_rpm-val ((m <OutputData>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader quadrotor_msgs-msg:motor_rpm-val is deprecated.  Use quadrotor_msgs-msg:motor_rpm instead.")
  (motor_rpm m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <OutputData>) istream)
  ...
  (cl:setf (cl:slot-value msg 'motor_rpm) (cl:make-array 4))
  (cl:let ((vals (cl:slot-value msg 'motor_rpm)))
    (cl:dotimes (i 4)
    (cl:let ((unsigned 0))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<OutputData>)))
  ...
  "7ff6c904c90ab995159b165f2f3eeacf")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'OutputData)))
  "Returns md5sum for a message object of type 'OutputData"
  "7ff6c904c90ab995159b165f2f3eeacf")
...
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <OutputData>))
  (cl:+ 0
     ...
     0 (cl:reduce #'cl:+ (cl:slot-value msg 'motor_rpm) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 2)))
     1
))
