...
class OutputData {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('motor_rpm')) {
        ...
        this.motor_rpm = new Array(4).fill(0);
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Check that the constant length array field [motor_rpm] has the right length
    if (obj.motor_rpm.length !== 4) {
      throw new Error('Unable to serialize array field motor_rpm - length must be 4')
    }
    // Serialize message field [motor_rpm]
    bufferOffset = _arraySerializer.int16(obj.motor_rpm, buffer, bufferOffset, 4);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.motor_rpm = _arrayDeserializer.int16(buffer, bufferOffset, 4)
  ...
  static md5sum() {
    ...
    return '7ff6c904c90ab995159b165f2f3eeacf';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.motor_rpm !== undefined) {
      ...
      resolved.motor_rpm = new Array(4).fill(0)
    }
