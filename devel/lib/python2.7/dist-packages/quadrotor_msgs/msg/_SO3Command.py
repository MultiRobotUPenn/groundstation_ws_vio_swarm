...
class SO3Command(genpy.Message):
  _md5sum = "6778903d02fc8f91a4ade288d0a1f3d6"
...
"""
  __slots__ = ['header','force','orientation','angular_velocity','aux','kR','kOm']
  _slot_types = ['std_msgs/Header','geometry_msgs/Vector3','geometry_msgs/Quaternion','geometry_msgs/Vector3','quadrotor_msgs/AuxCommand','float64[3]','float64[3]']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,force,orientation,angular_velocity,aux,kR,kOm
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_12d().pack(_x.force.x, _x.force.y, _x.force.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z, _x.aux.current_yaw, _x.aux.kf_correction))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.force.x, _x.force.y, _x.force.z, _x.orientation.x, _x.orientation.y, _x.orientation.z, _x.orientation.w, _x.angular_velocity.x, _x.angular_velocity.y, _x.angular_velocity.z, _x.aux.current_yaw, _x.aux.kf_correction,) = _get_struct_12d().unpack(str[start:end])
      start = end
      end += 16
